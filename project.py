...
# ------------------------- Custom Variance Filter (replaces scipy) -------------------------
def local_variance_filter(image, size=9):
    """
    Calculate local variance using convolution (replaces scipy.ndimage.generic_filter)
    """
...
def spatial_filtering(image):
    ...
    # 11. Local Variance (texture roughness map) - using custom implementation
    variance_map = local_variance_filter(gray, size=9)
